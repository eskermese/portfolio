...
const skillsSection = {
  ...
  skills: [
    emoji(
      "⚡ Develop scalable high performance Back-end"
    ),
  ...
  experience: [
    {
      ...
      company: "DooverTech",
      companylogo: require("./assets/images/doovertech.jpeg"),
      date: "Sept 2021 – Present",
      desc: "Software development.",
      descBullets: [
        "Development of E-commerce applications.",
        "Configuring CI/CD.",
        "Integration with third party services such as: Cloudpayments.kz, 1c, etc.",
      ]
    },
    {
      role: "Backend Developer",
      company: "Apptrix",
      companylogo: require("./assets/images/apptrix.png"),
      date: "Jan 2021 – Aug 2021",
      desc: "Software development.",
      descBullets: [
        "Development of E-commerce applications, CRM systems, etc.",
        "Integration with third party services such as: Aliexpress, Ozon, Yandex.Market, Google APIs, etc.",
        "Coding telegram bots, parsers, scripts",
        "Code Review",
      ]
    }
  ]
