...
const customIcons = {django: (<svg xmlns="http://www.w3.org/2000/svg" width="42" viewBox="0 0 256 256" version="1.1" preserveAspectRatio="xMidYMid">
    <g>
        <rect fill="#868e96" x="0" y="0" width="256" height="256" rx="28"/>
...
</svg>), fastapi: <svg xmlns="http://www.w3.org/2000/svg" fill="#868e96" width="42" viewBox="0 0 154 154"><circle cx="77" cy="77" fill="#868e96"r="77"/><path d="M81.375 18.667l-38.75 70H77.5l-3.875 46.666 38.75-70H77.5z" fill="#fff"/></svg>}
  return (
    <div>
          ...
          {skillsSection.softwareSkills.map((skills, i) => {
            return (
              ...
              >
                ...
                {skills.customIcon ? customIcons[skills.customIcon] : <i className={skills.fontAwesomeClassname}></i> }
